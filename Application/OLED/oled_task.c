...
{
	return OLEDLib_I2C_Init(OLEDx, msgDelay, isHWI2C);
}
...
{
	return OLEDLib_I2C_WriteCmd(OLEDx, cmd);
}
...
{
	return OLEDLib_I2C_WriteData(OLEDx, cmd);
}
...
{
	OLEDLib_I2C_SetPos(OLEDx, xPos, yPos);
}
...
{
	OLEDLib_I2C_DrawBMP(OLEDx, x0Pos, y0Pos, x1Pos, y1Pos,BMP);
}