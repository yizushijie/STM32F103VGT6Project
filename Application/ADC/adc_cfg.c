...
//===全局变量的定义
ADCASK_HandlerType	g_ABChannelADC;
pADCASK_HandlerType	pABChannelADC = &g_ABChannelADC;
ADCASK_HandlerType	g_CDChannelADC;
...
UINT8_T ADC_GPIO_Init(void)
{
	...
	//---ADCChannel12---PC2
	//---ADCChannel13---PC3
	GPIO_InitStruct.Pin = LL_GPIO_PIN_0 | LL_GPIO_PIN_1 | LL_GPIO_PIN_2 | LL_GPIO_PIN_3;					//---对应的GPIO的引脚
