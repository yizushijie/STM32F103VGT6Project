...
extern "C" {
	...
	//===YSEL1_A的配置
	#define YSEL0A_CTR_PORT								GPIOE
	#define YSEL0A_CTR_BIT								LL_GPIO_PIN_7
	...
	//===YSEL2_A的配置
	#define YSEL1A_CTR_PORT								GPIOE
	#define YSEL1A_CTR_BIT								LL_GPIO_PIN_8
	...
	//===YSEL3_A的配置
	#define YSEL2A_CTR_PORT								GPIOE
	#define YSEL2A_CTR_BIT								LL_GPIO_PIN_9
	...
	//===YSEL4_A的配置
	#define YSEL3A_CTR_PORT								GPIOE
	#define YSEL3A_CTR_BIT								LL_GPIO_PIN_10
	...
	//===YSEL1_B的配置
	#define YSEL0B_CTR_PORT								GPIOB
	#define YSEL0B_CTR_BIT								LL_GPIO_PIN_8
	...
	//===YSEL2_B的配置
	#define YSEL1B_CTR_PORT								GPIOB
	#define YSEL1B_CTR_BIT								LL_GPIO_PIN_9
	...
	//===YSEL3_B的配置
	#define YSEL2B_CTR_PORT								GPIOE
	#define YSEL2B_CTR_BIT								LL_GPIO_PIN_0
	...
	//===YSEL4_B的配置
	#define YSEL3B_CTR_PORT								GPIOE
	#define YSEL3B_CTR_BIT								LL_GPIO_PIN_1
	...
	//===YSEL1_C的配置
	#define YSEL0C_CTR_PORT								GPIOD
	#define YSEL0C_CTR_BIT								LL_GPIO_PIN_7
	...
	//===YSEL2_C的配置
	#define YSEL1C_CTR_PORT								GPIOD
	#define YSEL1C_CTR_BIT								LL_GPIO_PIN_6
	...
	//===YSEL3_C的配置
	#define YSEL2C_CTR_PORT								GPIOD
	#define YSEL2C_CTR_BIT								LL_GPIO_PIN_5
	...
	//===YSEL4_C的配置
	#define YSEL3C_CTR_PORT								GPIOD
	#define YSEL3C_CTR_BIT								LL_GPIO_PIN_4
	...
	//===YSEL1_D的配置
	#define YSEL0D_CTR_PORT								GPIOD
	#define YSEL0D_CTR_BIT								LL_GPIO_PIN_15
	...
	//===YSEL2_D的配置
	#define YSEL1D_CTR_PORT								GPIOD
	#define YSEL1D_CTR_BIT								LL_GPIO_PIN_14
	...
	//===YSEL3_D的配置
	#define YSEL2D_CTR_PORT								GPIOD
	#define YSEL2D_CTR_BIT								LL_GPIO_PIN_13
	...
	//===YSEL4_D的配置
	#define YSEL3D_CTR_PORT								GPIOD
	#define YSEL3D_CTR_BIT								LL_GPIO_PIN_12
	...
	//===高电压下的频率点个数
	#define FREQ_CURRENT_HIGH_FX100MHZ_NUM				100

	//===高电压下的起始频率
	#define FREQ_CURRENT_HIGH_FSTART_X100MHZ			20000
	...
	//===低电压下的起始频率
	#define FREQ_CURRENT_LOW_FSTART_X100MHZ				40000
	...
	//===高电压下的ADC合格最小值
	#define FREQ_CURRENT_LOW_ADC_PASS_MIN				0

	//===历史记录的最大值
	#define FREQ_CURRENT_HISTORY_MAX_SIZE				20

	//===采样电阻
	#define FREQ_CURRENT_SAMPLE_RES						50
	...
	//===设置第四频率点
	#define FREQ_YSEL4_X100MHZ							23000
